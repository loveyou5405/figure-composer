...
- `generateAutoLayoutCandidates(panels, region, settings, labelSettings)` returns deterministic score-sorted top-N label-aware candidates.
...
| Mode | unused | width imbalance | height variation | row-count variation | orphan | avoidable break | used height | movement | scaling |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Balanced | 1.2 | 2.0 | 0.4 | 0.5 | 30 | 0 | 0.2 | 0.1 | 25 |
| Compact | 0.4 | 0.5 | 0.2 | 0.2 | 12 | 100 | 2.5 | 0.05 | 25 |
| Equal Rows | 0.8 | 2.5 | 0.5 | 6.0 | 25 | 0 | 0.3 | 0.05 | 25 |
...
- 0.6.0: Center-aligned image rectangles within mixed labeled/unlabeled rows while retaining visible-label bounds in fit and collision calculations.
- 0.7.0: Aligned labeled panels by their label anchors while preserving preceding-image center alignment for unlabeled panels.
- 0.8.0: Preserved Figure ownership during project arrangement and inserted overflow pages before the next Figure.
